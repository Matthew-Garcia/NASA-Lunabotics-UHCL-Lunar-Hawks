...
The earlier '6A' figure remains ambiguous; it has not been accepted as total rover current or a verified DC switch rating. The cited 6 A resistive / 2 A inductive switch ratings lack manufacturer verification. Installed BAOMAIN direct switching remains unqualified. No schematic changes were made by this motor-identification update.
