...
class MissionManager(Node):
    ...
    def tick(self):
        ...
        if not enabled or not fresh or not self.safe:
            ...
            elif elapsed>12:self.state_to('FAULT')
            ...
            elif elapsed>4:self.state_to('FAULT')
            ...
            elif elapsed>10:self.state_to('FAULT')
        ...
        if self.state in ['FIND_GOAL','APPROACH','TURN_REAR','SCAN'] and not (stowed and lowered and latched):self.state_to('FAULT')
